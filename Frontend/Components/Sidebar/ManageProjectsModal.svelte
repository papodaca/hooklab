                ...
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap">
                    <input
                      ...
                      class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 text-sm text-gray-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500"
                    />
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
                    <select
                  ...
                  >
                    <button
                      ...
                      class="text-green-600 hover:text-green-900 dark:text-green-400 dark:hover:text-green-200 disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      disabled={isSubmitting}
                      class="ml-4 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200 disabled:opacity-50"
                      >Cancel</button
                    >
                  </td>
                </tr>
              ...
              {#each $projects.data as project (project.id)}
                {#if editingProject && editingProject.id === project.id}
                  <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <select
                        bind:value={editingProject.color}
                        class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 text-sm text-gray-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500"
                      >
                        {#each availableColors as color}
                          <option value={color}
                        ...
                        {#if deletingProjectId === project.id}
                          ...
                          >
                            ...
                            <button
                              ...
                              disabled={isSubmitting}
                              class="ml-4 text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-200 disabled:opacity-50"
                              >Yes</button
                            >
                            <button
                              on:click={handleCancel}
                              disabled={isSubmitting}
                              class="ml-2 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200 disabled:opacity-50"
                              >No</button
                            >
                          </div>
                        {:else}
                          ...
                          >
                            <button
                              ...
                              disabled={!!editingProject ||
                                ...
                                isSubmitting ||
                                !!deletingProjectId}
                              class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-200 disabled:opacity-50"
                              >Edit</button
                            >
                            <button
