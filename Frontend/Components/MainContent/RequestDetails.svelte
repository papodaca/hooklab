...
<div class="p-4">
  <div class="flex flex-wrap -mx-3">
    <div
      class="w-full px-3 mb-6 {params && Object.keys(params).length > 0
        ? 'md:w-1/2'
        : ''}"
    >
      <h3
      ...
      <div class="w-full md:w-1/2 px-3 mb-6">
        ...
        <div class="overflow-x-auto">
          ...
          >
            ...
            <tbody>
              {#each Object.entries(params).sort() as [key, value]}
                <tr
                  class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
                >
                  <th
  ...
  <div>
    ...
    {#if formattedBody}
      <pre
        class="bg-gray-50 dark:bg-gray-900 p-4 rounded-md overflow-x-auto text-sm text-gray-800 dark:text-gray-200 font-mono">{formattedBody}</pre>
    {:else}
